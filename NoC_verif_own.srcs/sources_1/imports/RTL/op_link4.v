module op_link4 (rd_clk, reset, req_link1_vc1, req_link1_vc2, req_link1_vc3, req_link1_vc4, req_link2_vc1, req_link2_vc2, req_link2_vc3, req_link2_vc4,
		req_link3_vc1, req_link3_vc2, req_link3_vc3, req_link3_vc4, req_core_vc1, req_core_vc2, req_core_vc3, req_core_vc4,    
      rok_link1_vc1, rok_link1_vc2, rok_link1_vc3, rok_link1_vc4, rok_link2_vc1, rok_link2_vc2, rok_link2_vc3, rok_link2_vc4, 
    ...
    rd_en_vc1_link2_vc1, rd_en_vc1_link2_vc2, rd_en_vc1_link2_vc3, rd_en_vc1_link2_vc4, 
       rd_en_vc1_link3_vc1, rd_en_vc1_link3_vc2, rd_en_vc1_link3_vc3, rd_en_vc1_link3_vc4, 
	    rd_en_vc1_core_vc1,  rd_en_vc1_core_vc2,  rd_en_vc1_core_vc3,  rd_en_vc1_core_vc4, rd_en_vc2_link1_vc1, rd_en_vc2_link1_vc2, rd_en_vc2_link1_vc3, rd_en_vc2_link1_vc4, 
...
input	rd_clk, reset, req_link1_vc1, req_link1_vc2, req_link1_vc3, req_link1_vc4, req_link2_vc1, req_link2_vc2, req_link2_vc3, req_link2_vc4,
		req_link3_vc1, req_link3_vc2, req_link3_vc3, req_link3_vc4, req_core_vc1, req_core_vc2, req_core_vc3, req_core_vc4,    
      rok_link1_vc1, rok_link1_vc2, rok_link1_vc3, rok_link1_vc4, rok_link2_vc1, rok_link2_vc2, rok_link2_vc3, rok_link2_vc4, 
	 	rok_link3_vc1, rok_link3_vc2, rok_link3_vc3, rok_link3_vc4, 
	   rok_core_vc1, rok_core_vc2, rok_core_vc3, rok_core_vc4, 
...
round_robin_req rrq1 ( .reset(reset), .rd_clk(rd_clk), .all_vc_not_busy(all_vc_not_busy), 
                       ...
                       .req_7(req_link2_vc3), .req_8(req_link2_vc4), .req_9(req_link3_vc1), .req_10(req_link3_vc2), .req_11(req_link3_vc3), .req_12(req_link3_vc4), .req_13(req_core_vc1), .req_14(req_core_vc2), .req_15(req_core_vc3), .req_16(req_core_vc4),
...
/*rrq1 (.tailer1( tailer_link1_vc1),
		...
		.tailer9( tailer_link3_vc1),
		.tailer10( tailer_link3_vc2),
		.tailer11( tailer_link3_vc3),
		.tailer12( tailer_link3_vc4),
...
/*					
assign mux_in =  {rok_link3_vc4, rok_link3_vc3, rok_link3_vc2, rok_link3_vc1, 
...
demux_16 dmux_opl1_1 (.ip(gnt_vc1), .sel({link_1,vc_id_1}), .op1(rd_en_vc1_link1_vc1), .op2(rd_en_vc1_link1_vc2), .op3(rd_en_vc1_link1_vc3), .op4(rd_en_vc1_link1_vc4), .op5(rd_en_vc1_link2_vc1), .op6(rd_en_vc1_link2_vc2), 
				.op7(rd_en_vc1_link2_vc3), .op8(rd_en_vc1_link2_vc4), .op9(rd_en_vc1_link3_vc1), .op10(rd_en_vc1_link3_vc2), .op11(rd_en_vc1_link3_vc3), .op12(rd_en_vc1_link3_vc4), .op13(rd_en_vc1_core_vc1), .op14(rd_en_vc1_core_vc2), .op15(rd_en_vc1_core_vc3), .op16(rd_en_vc1_core_vc4)	);
...
demux_16 dmux_opl1_2 (.ip(gnt_vc2), .sel({link_2,vc_id_2}), .op1(rd_en_vc2_link1_vc1), .op2(rd_en_vc2_link1_vc2), .op3(rd_en_vc2_link1_vc3), .op4(rd_en_vc2_link1_vc4), .op5(rd_en_vc2_link2_vc1), .op6(rd_en_vc2_link2_vc2), 
				.op7(rd_en_vc2_link2_vc3), .op8(rd_en_vc2_link2_vc4), .op9(rd_en_vc2_link3_vc1), .op10(rd_en_vc2_link3_vc2), .op11(rd_en_vc2_link3_vc3), .op12(rd_en_vc2_link3_vc4), .op13(rd_en_vc2_core_vc1), .op14(rd_en_vc2_core_vc2), .op15(rd_en_vc2_core_vc3), .op16(rd_en_vc2_core_vc4)	);
...
demux_16 dmux_opl1_3 (.ip(gnt_vc3), .sel({link_3,vc_id_3}), .op1(rd_en_vc3_link1_vc1), .op2(rd_en_vc3_link1_vc2), .op3(rd_en_vc3_link1_vc3), .op4(rd_en_vc3_link1_vc4), .op5(rd_en_vc3_link2_vc1), .op6(rd_en_vc3_link2_vc2), 
				.op7(rd_en_vc3_link2_vc3), .op8(rd_en_vc3_link2_vc4), .op9(rd_en_vc3_link3_vc1), .op10(rd_en_vc3_link3_vc2), .op11(rd_en_vc3_link3_vc3), .op12(rd_en_vc3_link3_vc4), .op13(rd_en_vc3_core_vc1), .op14(rd_en_vc3_core_vc2), .op15(rd_en_vc3_core_vc3), .op16(rd_en_vc3_core_vc4)	);
...
demux_16 dmux_opl1_4 (.ip(gnt_vc4), .sel({link_4,vc_id_4}), .op1(rd_en_vc4_link1_vc1), .op2(rd_en_vc4_link1_vc2), .op3(rd_en_vc4_link1_vc3), .op4(rd_en_vc4_link1_vc4), .op5(rd_en_vc4_link2_vc1), .op6(rd_en_vc4_link2_vc2), 
				.op7(rd_en_vc4_link2_vc3), .op8(rd_en_vc4_link2_vc4), .op9(rd_en_vc4_link3_vc1), .op10(rd_en_vc4_link3_vc2), .op11(rd_en_vc4_link3_vc3), .op12(rd_en_vc4_link3_vc4), .op13(rd_en_vc4_core_vc1), .op14(rd_en_vc4_core_vc2), .op15(rd_en_vc4_core_vc3), .op16(rd_en_vc4_core_vc4)	);
