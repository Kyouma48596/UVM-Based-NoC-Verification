...
namespace XILINX_DPI { 
	...
	void dpiInitialize()
	{
		...
		DPIRelocateDPIScopeIP(0, (char*)(0x98eec0)) ;
...
extern "C" {
	...
	extern void subprog_m_9f73c736_556ead11_2245(char*, char*, char*);
}
...
extern "C" {
...

	{
		...
		SP = DPIInitializeFunction(IP + 429824, 168, 6076952) ;
		char driver0[32] ;
		...
		DPIInvokeFunction(IP + callingProcessOffset, SP, (void*)(subprog_m_9f73c736_556ead11_2245), IP) ;
