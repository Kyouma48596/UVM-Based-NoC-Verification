...
REM
REM Generated by Vivado on Fri Apr 08 12:35:17 +0530 2022
...
echo "xvlog --incr --relax -L uvm -d 2x3=1 -prj tb_top_vlog.prj"
call xvlog  --incr --relax -L uvm -d 2x3=1 -prj tb_top_vlog.prj -log xvlog.log
